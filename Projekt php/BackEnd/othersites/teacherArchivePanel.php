                ...
                <div class="container mx-auto mb-2 mt-3 teacher-form-box">
                    <div class="row justify-content-center py-5">
                        <div class="col-lg col-md-6  col-sm-7 pb-3">
                            <form action="teacherTestsDatabase.php" method="post">
                        ...
                        <div class="col-lg col-md-6  col-sm-7 pb-3">
                            <form action="teacherAttemptsDatabase.php" method="post">
                                <div class="teacher-btns" onclick="this.parentNode.submit()">Baza prób studentów<br /><i
